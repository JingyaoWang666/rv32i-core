...
HD_PWD='D:/vivado_projects/project_8.2/project_8.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_cpu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_cpu_top.tcl
