...
HD_PWD='D:/vivado_projects/project_8.2/project_8.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_cpu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_cpu_top.tcl -notrace
