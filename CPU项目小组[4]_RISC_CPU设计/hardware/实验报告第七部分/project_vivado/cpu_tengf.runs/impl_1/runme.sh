...
HD_PWD='D:/Vivado_project/cpu_tengf/cpu_tengf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32i_cpu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rv32i_cpu.tcl -notrace
