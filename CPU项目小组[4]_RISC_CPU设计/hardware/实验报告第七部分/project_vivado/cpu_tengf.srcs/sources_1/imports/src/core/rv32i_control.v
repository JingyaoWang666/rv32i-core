...
module rv32i_control (
    ...
    output reg [2:0]  mem_to_reg,  //used for rd_data_mux,in write-back session. 000: writeback from mem, 001: from ALU, 010:from PC+4, 011:for LUI, 100: for AUIPC
