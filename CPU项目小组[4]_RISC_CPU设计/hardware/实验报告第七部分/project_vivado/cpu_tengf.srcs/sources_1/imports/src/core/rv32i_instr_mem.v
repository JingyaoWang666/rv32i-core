...
initial begin
    ...
    //$readmemh("LUI_test.mem", instr_mem, 0, `INSTR_MEM_DEPTH-1);
    //$readmemh("AUIPC_test.mem", instr_mem, 0, `INSTR_MEM_DEPTH-1);
    //$readmemb("inst_mem_init+SWLW.mem", instr_mem, 0, `INSTR_MEM_DEPTH-1);
end
