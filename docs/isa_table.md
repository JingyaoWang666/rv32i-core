Core Instruction Encoding Table (RV32I)

This table is essential for your Decoder logic. You can use the Opcode to distinguish instruction types (I, R, S, B, U, J) and then Funct3/Funct7 to determine the specific ALU operation.
